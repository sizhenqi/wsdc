      ...
      <table class="layui-table">
        ...
        <thead>
          <tr>
            ...
            <td class="td-manage">
              ...
              <a title="编辑"  onclick="x_admin_show('编辑','/admin/config/edit/{{$v -> id}}')" href="javascript:;">
        ...
        <thead>
          <tr>
            ...
            <td class="td-manage">
              <a onclick="member_stop(this,'10001')" href="javascript:;" id = 'ajax1' value="{{$v->status}}"  title="启用">
                <i class="layui-icon" >&#xe601;</i>
              </a>
            </td>
            @else
            ...
            <td class="td-manage">
              <a onclick="member_stop(this,'10001')" href="javascript:;" id = 'ajax2' value="{{$v ->status}}"  title="停用">
                <i class="layui-icon" >&#xe601;</i>
              </a>
            </td>
            @endif
