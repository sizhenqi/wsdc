...
<div class="login">
	...
	<form method="post" action="/admin/dologin">
		...
		<input type="text" name="captcha" placeholder="验证码" required="required" style="width: 55%"/> &nbsp;&nbsp;<img src="/admin/captcha" alt="" onclick='this.src = this.src+="?1"'>
